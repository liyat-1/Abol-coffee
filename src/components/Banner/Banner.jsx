...
import BannerImg from "../../assets/africa.png";
          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                <h1
                  data-aos="fade-up"
                  className="text-3xl text-smoke sm:text-4xl font-bold font-cursive"
                >
                 በመላው ኢትዮጵያ ታገኙናላችሁ
                </h1>
                <p
                  data-aos="fade-up"
                  className="text-sm text-gray-200 tracking-wide leading-5"
                >
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-5">
                    <div data-aos="fade-up" className="flex items-center gap-3">
                      ...
                      <span
                      className="text-b1  font-cursive"
                      >Arabica</span>
                    </div>
                    <div
                      data-aos="fade-up"
                    ...
                    >
                      ...
                      <span  className="text-b1 font-cursive">Robusta</span>
                    </div>
                    <div
                      data-aos="fade-up"
                      data-aos-delay="500"
                    ...
                    >
                      ...
                      <span  className="text-b1 font-cursive">Excelsa</span>
                    </div>
                  </div>
                  <div
                    data-aos="slide-left"
                  ...
                  >
                    <h1 className="text-2xl text-smoke font-semibold font-cursive ">
                    ለቡና አፍቃሪዎች
                    </h1>
